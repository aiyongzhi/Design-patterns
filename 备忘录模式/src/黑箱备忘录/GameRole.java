...
public class GameRole {
    ...
    //提供一个方法恢复到之前的状态
    public void reBack(Memento memento){
        RoleStatusMemento roleStatusMemento=(RoleStatusMemento)memento;
        this.hp=roleStatusMemento.getHp();
        this.ack=roleStatusMemento.getAck();
    ...
    public static class RoleStatusMemento implements Memento{
        private String name;
        private int hp;//英雄血量
        private int ack;//英雄攻击力
        private int def;//英雄防御力
